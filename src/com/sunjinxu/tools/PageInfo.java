...
public class PageInfo<T> implements Serializable {
	...
	public int size;	// 当前页的数量
	public int startRow;// 当前页面第一个元素在数据库中的行号
	public int endRow;// 当前页面最后一个元素在数据库中的行号
	public long total;// 总记录数
	public int pages;// 总页数
	public List<T> list;// 结果集
	...
	public int[] navigatepageNums;// 所有导航页号
