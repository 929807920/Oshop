	...
	<div class="container">
		...
		<div class="row row-offcanvas row-offcanvas-right">
			...
			<div class="col-xs-12 col-sm-9">
				<form class="createpost" action="insertPost" method="post"
					name="createpost">
					<div class="form-group">
						<label for="title">标题</label> 
						<input type="text" name="title" value="" class="form-control" id="title" placeholder="文章标题" maxlength="25" autofocus required>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<textarea type="text" name="content" value="" class="form-control" id="content" rows="9" required></textarea>
					</div>
					<div class="form-group">
						<label for="typeId">类型</label> 
						<select class="form-control" name="typeId" value="" class="form-control" id="typeId" required> </select>
					</div>
					<div class="form-group">
						<label for="tagName">标签</label> 
						<input type="text" name="tagName" value="" class="form-control" id="tagName" maxlength="10" required>
					</div>
