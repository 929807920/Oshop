                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12">
                                <div class="cart-tab-menu section-tab-menu pb-50 text-center">
                                    <ul>
                                        <li class="text-uppercase active"><a href="cart.jsp">Shopping Cart</a></li>
                                        <li class="text-uppercase"><a href="checkout.jsp">Checkout</a></li>
                            ...
                            <div class="col-sm-6">
                                <div class="cart-coupon-rightside pt-50">
                                    ...
                                    <div class="check-update pull-right">
                                        ...
                                        <a href="checkout.jsp" class="checkout mt-25 section-button">Checkout</a>
                                    </div>    
                                </div>
                            </div>
                        </div>
