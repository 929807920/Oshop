                                        ...
                                        <form id="contact-form-two" action="mail.php" method="post">
                                            <div class="form-top">
                                                <div class="form-group col-xs-12">
                                                    <label>Your Name<span class="required" title="required">*</span></label>
                                                ...
                                                <div class="form-group col-xs-12">
                                                    <label>Subject<span class="required" title="required">*</span></label>
                                            ...
                                            <div class="submit-form form-group col-xs-12 submit-review text-center">
                                                ...
                                                <button class="section-button mt-20" type="submit"><span>Send Message</span></button>
                                            </div>
                                        </form>
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="google-address">
                                        <ul>
                                            ...
                                            <li><img src="img/icon/13.png" alt="">Email : <span><a href="#"> admin@sc.chinaz.com</a></span> <br>Web: <a href="sc.chinaz.com"> sc.chinaz.com</a></li>
                                        </ul>
                                    </div>    
                                </div>     
                            </div>   
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="touch-right">
                                    ...
                                    <form id="contact-form" action="mail-two.php" method="post">
